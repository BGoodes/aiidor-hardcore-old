...
public class Cubism extends AiidorEnchant  implements Listener {
	
	public Cubism(NamespacedKey id) {
		super(id);
	}
	...
	public void onHit(EntityDamageByEntityEvent e) {
		if (e.getDamager() instanceof LivingEntity) {
			...
			if (e.getEntityType() == EntityType.SLIME || e.getEntityType() == EntityType.MAGMA_CUBE || e.getEntityType() == EntityType.CREEPER || e.getEntityType() == EntityType.GHAST) {
