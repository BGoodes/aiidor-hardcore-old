...
public class Feather_Wiper extends AiidorEnchant  implements Listener {
	
	public Feather_Wiper(NamespacedKey id) {
		super(id);
	}
	...
	public void onHit(EntityDamageByEntityEvent e) {
		if (e.getDamager() instanceof LivingEntity) {
			...
			if (e.getEntityType() == EntityType.PHANTOM || e.getEntityType() == EntityType.VEX || e.getEntityType() == EntityType.GHAST || e.getEntityType() == EntityType.BLAZE || 
				e.getEntityType() == EntityType.BAT || e.getEntityType() == EntityType.BEE || e.getEntityType() == EntityType.ENDER_DRAGON || e.getEntityType() == EntityType.CHICKEN ||
				e.getEntityType() == EntityType.WITHER || e.getEntityType() == EntityType.PARROT) {
	...
	public boolean conflictsWith(Enchantment enchant) {
		...
		if (enchant.equals(AiidorEnchant.INHUMAN)) return true;
